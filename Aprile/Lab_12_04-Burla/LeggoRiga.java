/**
 * lettura di un file di testo parola per parola: cerco parola in un file
 * 
 * @author Thomas Burla
 * @version 1.0
 */
...
public class LeggoRiga {
    public static void main(String args[]){
        ...
        try{
            ...
            //leggo il file finchè ci sono righe
            ...
            if(!(posizione.equals(""))){
                ...
                JOptionPane.showMessageDialog(null, "La parola NON � presente nel testo");
            }
            leggoFile.close();
        }catch(IOException e){
