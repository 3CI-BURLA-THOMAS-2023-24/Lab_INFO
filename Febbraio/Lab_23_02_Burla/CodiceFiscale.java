...
public class CodiceFiscale{
    public static void main(String args[]){
        ...
        String nome, cognome, luogo_n, provincia_n, sesso, nome_max, cognome_max, nome_fisc, cognome_fisc, anno_fisc, anno_str, mese, giorno_str, data_n, comune_n, controllo_pari[], controllo_dispari[], controllo_str, codice_fisc;
